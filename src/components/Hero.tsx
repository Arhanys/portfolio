...
export default function Hero() {
  ...
  return (
    <section className="h-[90%] hidden lg:flex flex-col items-center overflow-hidden relative">
      ...
      <h1
        id="heroTitle"
        className="h-2/3 font-archivo flex items-center justify-center text-[27vw]  text-special cursor-default"
      >
        <span>E</span>
        <span>t</span>
        <span>h</span>
      ...
      <TypeIt
        ...
        getBeforeInit={(instance) => {
          instance
            .type("Front-end Dev and Designer.")
            .pause(750)
            .delete(9)
            .pause(500)
            .type("Musician.")
